...
RDEPEND="${PYTHON_DEPS}
	...
	plugins? ( sci-libs/fftw:3.0 dev-libs/libxml2 sys-libs/zlib x11-libs/ntk virtual/opengl )
...
src_compile() {
	myemakeargs=(
		...
		HAVE_LV2UI=$(usex lv2ui true false)
		HAVE_PLUGINS=$(usex plugins true false)
		HAVE_SAMPLERS=$(usex samplers true false)
	)
