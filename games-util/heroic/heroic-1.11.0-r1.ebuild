...
DESCRIPTION="a Native alternative Linux Launcher for Epic Games (alpha)"
HOMEPAGE="https://github.com/Heroic-Games-Launcher/HeroicGamesLauncher"
SRC_URI="https://github.com/Heroic-Games-Launcher/HeroicGamesLauncher/releases/download/v${PV}-beta.2/${PN}-${PV}-beta.2.tar.xz"
...
src_install() {
	...
	insinto /opt
	doins -r .
	mv ../image/opt/${P}-beta.2 ../image/opt/${PN}
	fperms +x /opt/${PN}/${PN}
